...
function RefreshButton({ onClick, loading }) {
  return (
    <button
      onClick={onClick}
      disabled={loading}
      className="px-4 py-2 primary-gradient text-white text-xs font-semibold uppercase tracking-wider rounded-lg shadow-sm hover:opacity-90 transition-opacity flex items-center gap-2 disabled:opacity-50"
    >
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <header className="glass-header ambient-shadow sticky top-0 z-50 flex justify-between items-center w-full px-6 py-3 flex-shrink-0">
        <div className="flex items-center gap-4">
          <span className="text-xl font-bold tracking-tight text-primary">System Observability</span>
        </div>
