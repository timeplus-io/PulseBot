...
export default function Layout({ children }) {
  return (
    <div className="flex h-screen bg-surface overflow-hidden">
      {/* Sidebar */}
      <aside className="w-56 flex-shrink-0 flex flex-col primary-gradient">
        {/* Logo */}
        <div className="px-5 py-5 border-b border-white/10">
          <img src="/static/assets/pulsebot_logo_white.svg" alt="PulseBot" className="h-7 w-auto block" />
        </div>
